...
public class Almacenamiento implements Serializable {
	...
	public static Usuario crearUsuario(String nombre, int identificacion, int telefono, String tipo,
			String cuentaBancaria, ArrayList<Factura> arrayList) {
	...
	public static void setLHabitaciondis(List<Lugar> habitaciondis) {
		Almacenamiento.habitaciondis = habitaciondis;
	}

	public static List<Lugar> getHabitaciondis() {
		return habitaciondis;
	}
